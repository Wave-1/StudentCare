...
export default function StudentList() {
  ...
  const editData = (studentID, studentName, birthday, studentClass, course, industry, phoneNumber, email, placeOfBirth, permanentResidence, yearOfStudy, faculty, roleID) => {
    const data = {
      studentID: studentID,
          ...
          <Table className="sticky top-0" aria-label="sticky table">
            <TableHead>
              <TableRow>
                ...
                <TableCell className="min-w-100">Industry</TableCell>
