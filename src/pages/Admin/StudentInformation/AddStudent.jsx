...
export default function AddStudent({ onClose }) {
    ...
    const createStudent = async () => {
        ...
        if (!studentData.studentID || !studentData.studentName || !studentData.birthday || !studentData.studentClass ||
            !studentData.course || !studentData.industry || !studentData.phoneNumber || !studentData.email ||
        ...
        //Xây dựng API
        const apiUrl = `${API_BASE_URL}${API_ROUTES.Student}`;
        ...
        try {
            const response = await axios.post(apiUrl, newStudentData, {
                headers: API_HEADERS
            });
            if (response.status === 200) {
                ...
                onClose();
                Swal.fire("Add Student Successfully !!!", "", "success");
